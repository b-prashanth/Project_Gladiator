...
create table Employment_Details(user_id int primary key references User_Details(User_id) on delete cascade on update cascade, 
type_of_emp varchar(50) , annual_sal numeric(20) , existing_emi varchar(10) )

create table Admin_Details(Admin_id int identity(100,1) primary key , Admin_UserName nvarchar(30) not null ,
Admin_password nvarchar(20) , Admin_Email nvarchar(250) )  
...
user_ref_id int references User_Details(User_id) ,
loan_id int references Loan_Applications(Application_id) ,
...
create table bank_details( Account_Num numeric ,
user_ref_id int references User_Details(User_id) ,
account_type nvarchar(100) ,branch_name nvarchar(50) , 
ifsc_code nvarchar(20), primary key (Account_Num,user_ref_id) )

create table Rejected_list( rejected_id int identity(10,1) primary key,
admin_ref_id int references Admin_Details(Admin_id) ,
user_ref_id int references User_Details(User_id) ,
loan_id int references Loan_Applications(Application_id) ,
...
insert into Admin_Details (Admin_UserName,Admin_password,Admin_Email) values 
('AdityaaVijay' ,'adityaaVijay23','adityaVijay@gmail.com'),
('prashanth' ,'bp$23','prashanth99@gmail.com'),
('geethika' ,'geethika505','geethika505@gmail.com'),
('Jainisha' ,'jainisha&07','jainisha07@gmail.com')
...
insert into bank_details (Account_Num,user_ref_id,account_type,branch_name,ifsc_code) values
(10564859,1,'savings','anna nagar','icici0007'),
(10564479,1,'current','anna nagar','icici0007')
